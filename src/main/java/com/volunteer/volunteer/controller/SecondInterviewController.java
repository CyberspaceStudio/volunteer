...
public class SecondInterviewController {
    ...
    public UniversalResponseBody PcWaitSecondInterviewed(HttpServletRequest httpServletRequest) {
        ...
        Map<String, List<Map<String, Object>>> res = enrollPersonService.PcWaitSecondInterviewed(department);
        if (res != null) {
    ...
    public UniversalResponseBody PcSecondInterviewed(HttpServletRequest httpServletRequest) {
        ...
        Map<String, List<Map<String, Object>>> res = enrollPersonService.PcSecondInterviewed(department);
        if (res != null) {
            return new UniversalResponseBody<>(0, "success", res);
        } else {
            return new UniversalResponseBody(-1, "failed");
